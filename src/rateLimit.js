 ...
 * @param {(...args)=>any} operation Operation that should be rate-limited.
 * @param {number} interval Time interval (in ms).
 * @param {*} requestsPerInterval Maximum number of requests within the interval.
 * @returns {(...args)=>Promise<any>} Rate-limited version of the given operation.
 */
