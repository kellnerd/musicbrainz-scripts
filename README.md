...
```js
javascript:(function(){var n=(n=['input#name','input#comment','input.track-name','input[id^=disc-title]','input[name$=\\.name]','input[name$=\\.comment]']).join(),a=[[/(?<=\W|^)"(.+?)"(?=\W|$)/g,'\u201c$1\u201d'],[/(?<=\W|^)'n'(?=\W|$)/g,'\u2019n\u2019'],[/(?<=\W|^)'(.+?)'(?=\W|$)/g,'\u2018$1\u2019'],[/(\d+)"/g,'$1\u2033'],[/(\d+)'(\d+)/g,'$1\u2032$2'],[/'/g,'\u2019'],[/(?<!\.)\.{3}(?!\.)/g,'\u2026'],[/ - /g,' \u2013 '],[/(\d{4})-(\d{2})-(\d{2})(?=\W|$)/g,'$1\u2010$2\u2010$3'],[/(\d{4})-(\d{2})(?=\W|$)/g,'$1\u2010$2'],[/(\d+)-(\d+)/g,'$1\u2013$2'],[/-/g,'\u2010']];$(n).css('background-color',''),$(n).each((n,e)=>{let g=e.value;g&&(a.forEach(([$,n])=>{g=g.replace($,n)}),g!=e.value&&$(e).val(g).trigger('change').css('background-color','yellow'))})})();
```
